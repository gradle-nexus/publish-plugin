...
tasks {
    afterEvaluate {
        ...
        withType<KotlinCompile>().configureEach {
            ...
            // Note: this leaves kotlinOptions.languageVersion = "1.8" as set by Kotlin DSL plugin.
            // This means we can get benefits from "New Inference" and other features,
            // while the generated bytecode is still compatible with Kotlin 1.3.
            doFirst {
